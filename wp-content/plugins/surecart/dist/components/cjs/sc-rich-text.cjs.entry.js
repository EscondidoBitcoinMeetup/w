...
const ScRichText = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return (index.h(index.Host, { key: 'ee3222f42bcd962038aa3fb3d4911be1a3fdcb34' }, index.h("sc-form-control", { key: '63b2604ece556c53abc0d3866207ce7768999066', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("div", { key: '63e1927c4892457de430741bf0f238d06fce10a8', part: "base", class: { 'editor-base': true, 'editor--focused': this.hasFocus } }, index.h("div", { key: '26ef814f380790a829e0ef93c1333e1c1ff781a4', class: "menu" }, index.h("sc-button", { key: 'ca473802d91f8ddc2a49678f380ee66d7a89165d', size: "small", type: ((_b = (_a = this.editor) === null || _a === void 0 ? void 0 : _a.isActive) === null || _b === void 0 ? void 0 : _b.call(_a, 'bold')) ? 'default' : 'text', onClick: () => this.run('toggleBold'), disabled: !this.can('toggleBold') }, index.h("sc-icon", { key: '72207fda7f9d1b86e491c9935dcbe107a267105e', name: "bold" })), index.h("sc-button", { key: '49ad9896bb64f371fc5c794d932e91c9beafc097', size: "small", type: ((_d = (_c = this.editor) === null || _c === void 0 ? void 0 : _c.isActive) === null || _d === void 0 ? void 0 : _d.call(_c, 'italic')) ? 'default' : 'text', onClick: () => this.run('toggleItalic'), disabled: !this.can('toggleItalic') }, index.h("sc-icon", { key: '7f57b110feda9c1c14b6955fe11ada55749e9234', name: "italic" })), index.h("sc-button", { key: '0e6156c634f20b7be670493b1801cde4b07c19df', size: "small", type: ((_f = (_e = this.editor) === null || _e === void 0 ? void 0 : _e.isActive) === null || _f === void 0 ? void 0 : _f.call(_e, 'bulletList')) ? 'default' : 'text', onClick: () => this.run('toggleBulletList') }, index.h("sc-icon", { key: '5f8d23e968ddbc19008bf26e2bd5ed7d08afff86', name: "list" })), index.h("sc-button", { key: '2a10d8aa2eab2e9951ebe76d3e427f27373507a5', size: "small", type: ((_h = (_g = this.editor) === null || _g === void 0 ? void 0 : _g.isActive) === null || _h === void 0 ? void 0 : _h.call(_g, 'strike')) ? 'default' : 'text', onClick: () => this.run('toggleStrike') }, index.h("sc-icon", { key: '8d4a32003615bff1dd93aacaba67ebf19ae1e2a9', name: "minus" })), index.h("sc-button", { key: 'f62ba126e4f4903f1831b13dee4e6476dc8d73d3', class: "right", size: "small", type: "text", onClick: () => this.run('undo'), disabled: !this.can('undo') }, index.h("sc-icon", { key: '08ce8192d928462a5410786948d68c3c622e7bac', name: "corner-up-left" })), index.h("sc-button", { key: 'e9722d9808a68935e973fdacbde3a235ec4179b7', size: "small", type: "text", onClick: () => this.run('redo'), disabled: !this.can('redo') }, index.h("sc-icon", { key: '4c4b746a4a2ae8280b090b1474f6920774b0da3b', name: "corner-up-right" }))), index.h("div", { key: '3f3f1209e8ea942349b018ef7bac55b65aab83a8', part: "editor", class: {
                editor: true,
            }, ref: el => (this.element = el) })), this.remainingCharacters() < 20 && index.h("div", { key: 'e00bda314751948975731f02b01d18937b364dfa', class: 'textarea__char-limit-warning' }, wp.i18n.sprintf(wp.i18n.__('%d characters remaining', 'surecart'), this.remainingCharacters())))));
    }
};
