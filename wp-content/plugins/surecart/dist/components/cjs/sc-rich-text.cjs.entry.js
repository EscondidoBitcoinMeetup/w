...
const ScRichText = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return (index.h(index.Host, { key: 'ce3572cc50e35a5be3d016a4f1e9bdc20afca2f7' }, index.h("sc-form-control", { key: '7fae81f4e07154ec14da9ced8a3d42badeebfa4c', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, index.h("div", { key: '7fbf022a5b0b7ef1fe679b78f38b64334a6c8c3c', part: "base", class: { 'editor-base': true, 'editor--focused': this.hasFocus } }, index.h("div", { key: '9b7e08242eb26bb84b37d36e89a3a5246c51f18f', class: "menu" }, index.h("sc-button", { key: '1f30aa55e37fc53875fa2ba546472773bcbda213', size: "small", type: ((_b = (_a = this.editor) === null || _a === void 0 ? void 0 : _a.isActive) === null || _b === void 0 ? void 0 : _b.call(_a, 'bold')) ? 'default' : 'text', onClick: () => this.run('toggleBold'), disabled: !this.can('toggleBold') }, index.h("sc-icon", { key: 'a0b2ed89a6ded811c553702a3b4ca03e15dfbd25', name: "bold" })), index.h("sc-button", { key: '3580db2f66a619232f9708e682721582fa4cd8be', size: "small", type: ((_d = (_c = this.editor) === null || _c === void 0 ? void 0 : _c.isActive) === null || _d === void 0 ? void 0 : _d.call(_c, 'italic')) ? 'default' : 'text', onClick: () => this.run('toggleItalic'), disabled: !this.can('toggleItalic') }, index.h("sc-icon", { key: 'd267dbe489ad45999418c1aa7a0c8ad37c059f15', name: "italic" })), index.h("sc-button", { key: '0270dcc1b0a334e5f2854ab96ff8f9cc0ae15255', size: "small", type: ((_f = (_e = this.editor) === null || _e === void 0 ? void 0 : _e.isActive) === null || _f === void 0 ? void 0 : _f.call(_e, 'bulletList')) ? 'default' : 'text', onClick: () => this.run('toggleBulletList') }, index.h("sc-icon", { key: 'd1bc9ee9c06a4002a1b6065b422db6896cc7c2c1', name: "list" })), index.h("sc-button", { key: '72a168fcb3f6520c8849d059c9e0d6a7223f98bf', size: "small", type: ((_h = (_g = this.editor) === null || _g === void 0 ? void 0 : _g.isActive) === null || _h === void 0 ? void 0 : _h.call(_g, 'strike')) ? 'default' : 'text', onClick: () => this.run('toggleStrike') }, index.h("sc-icon", { key: '39ab0ea70ffacca1980a99d6b09d41dfb29bd30f', name: "minus" })), index.h("sc-button", { key: '6184b468e575b7b4acdb68fa7fa1513e73d77784', class: "right", size: "small", type: "text", onClick: () => this.run('undo'), disabled: !this.can('undo') }, index.h("sc-icon", { key: '0e515125388d0eac2a79a24caffa8e243a9c3af1', name: "corner-up-left" })), index.h("sc-button", { key: '56bfff5a07fa3a813166efd036f0df5c1c43d8b1', size: "small", type: "text", onClick: () => this.run('redo'), disabled: !this.can('redo') }, index.h("sc-icon", { key: '6b5d6c2d9ee20baa79322c5866fb03899d00ebb7', name: "corner-up-right" }))), index.h("div", { key: '7701d90ec46fb22259b9990763f84b9396b186aa', part: "editor", class: {
                editor: true,
            }, ref: el => (this.element = el) })), this.remainingCharacters() < 20 && index.h("div", { key: '659bd6d60ee3467f9069126db81bf2a591adbda4', class: 'textarea__char-limit-warning' }, wp.i18n.sprintf(wp.i18n.__('%d characters remaining', 'surecart'), this.remainingCharacters())))));
    }
};
