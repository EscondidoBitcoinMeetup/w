...
const ScSwitch = class {
    ...
    render() {
        ...
        return (index.h(Tag, { key: '9a1e0044fa54d532eb4659391679a2bfc70c55f1', part: "base", htmlFor: this.switchId, class: {
                'switch': true,
            ...
            }, onMouseDown: e => this.handleMouseDown(e) }, index.h("span", { key: 'e2d7dab44fb083581aae418b0d0fbd23d2a1ba27', part: "control", class: "switch__control" }, index.h("span", { key: 'bdd43aae441e3fb493e94f2c630642262d54879f', part: "thumb", class: "switch__thumb" }), index.h("input", { key: '603b39baceb601e8cad49741f4ee492d3e3ea361', ref: el => (this.input = el), id: this.switchId, type: "checkbox", role: "switch", name: this.name, value: this.value || 'on', checked: this.checked, disabled: this.disabled, required: this.required, "aria-checked": this.checked ? 'true' : 'false', "aria-labelledby": this.labelId, onClick: () => this.handleClick(), onBlur: () => this.handleBlur(), onFocus: () => this.handleFocus(), onKeyDown: e => this.handleKeyDown(e) })), index.h("span", { key: '0dc4607f10d244d3d82d8e2bf841dd82f0026f78', class: "switch__label", part: "label" }, index.h("span", { key: 'e4820591f6dc2cea711cb919bf3e0b87d6b8e6ab', part: "title", id: this.labelId, class: "switch__title" }, index.h("slot", { key: '21ff507712fcf566d9dc0f6d3ab3811d8a13095f' })), index.h("span", { key: 'e39f041310b6c578988fd5371120fb2c2d8d5944', class: "switch__description", part: "description" }, index.h("slot", { key: '1337e06f33f3ec26fd34e27a19d1555280987a9c', name: "description" })))));
    }
