...
const ScCustomerDetails = class {
    ...
    render() {
        var _a, _b, _c;
        return (index.h("sc-dashboard-module", { key: '02e68517b43466ff5843b30f2a701507ac30f764', exportparts: "base, heading, heading-text, heading-title, heading-description", class: "customer-details", error: this.error }, index.h("span", { key: '063195a49328d8c8804e0263a35b540baf8c1e08', slot: "heading" }, this.heading || wp.i18n.__('Billing Details', 'surecart'), ' ', !!((_a = this === null || this === void 0 ? void 0 : this.customer) === null || _a === void 0 ? void 0 : _a.id) && !((_b = this === null || this === void 0 ? void 0 : this.customer) === null || _b === void 0 ? void 0 : _b.live_mode) && (index.h("sc-tag", { key: '9306f1fa20c6fb186d99313864fecb8c7d416355', exportparts: "base:test-tag__base, content:test-tag__content", type: "warning", size: "small" }, wp.i18n.__('Test', 'surecart')))), !!this.editLink && !!((_c = this.customer) === null || _c === void 0 ? void 0 : _c.id) && (index.h("sc-button", { key: '6e6c4f3dfa8a860b161c5bd22931a0ac8497a7b9', exportparts: "base:button__base, label:button__label, prefix:button__prefix", type: "link", href: this.editLink, slot: "end" }, index.h("sc-icon", { key: '4f158a11ddcd2d0660ca4f2418973cc5101e45b9', name: "edit-3", slot: "prefix" }), wp.i18n.__('Update', 'surecart'))), this.renderContent()));
    }
