...
const ScSubscriptionDetails = class {
    ...
    render() {
        return (h("div", { key: '4f306b0838ef4284dc620a4d48911d81b8b5fc6c', class: "subscription-details" }, this.hasPendingUpdate && (h("div", { key: '6c06fd1e1ceb5dbf58a70465b993e9e96e285b28' }, h("sc-tag", { key: '98219ea9f0e8213aa81acd124d5addc0f0512ea5', size: "small", type: "warning" }, wp.i18n.__('Update Scheduled', 'surecart')))), h("sc-flex", { key: '18c3ddcfb491dfcbc21351d37667ab378657efa0', alignItems: "center", justifyContent: "flex-start" }, h("sc-text", { key: 'df5cb601fae315a6d07207a1a7a5128b00d01c91', "aria-label": wp.i18n.sprintf(
            /* translators: %s: plan name */
            wp.i18n.__('Plan name - %s', 'surecart'), this.renderName()), style: { '--font-weight': 'var(--sc-font-weight-bold)' } }, this.renderName()), this.renderActivations()), !this.hideRenewalText && h("div", { key: '3000c66c17de16d3c90b4f633dae2611d76c2355' }, this.renderRenewalText(), " "), h("slot", { key: 'c4c8bd4d8bdcc1a6fb0462250abaa6d411743cb1' }), h("sc-dialog", { key: 'dbdbc1de74e2cde687f4fadcc955d9bb9cf851ec', label: wp.i18n.__('Activations', 'surecart'), onScRequestClose: () => (this.activationsModal = false), open: !!this.activationsModal }, h("sc-card", { key: 'ea0006b75cdaba8c660f3c74c8573150d11bfc7c', "no-padding": true, style: { '--overflow': 'hidden' } }, h("sc-stacked-list", { key: '070401812f91b97cc074bb2655334ee888494316' }, (this.getActivations() || []).map(activation => {
        ...
        })))), this.showWarning() && (h("div", { key: '9fa38c64884bf65db164aa5b16b2a2ca8c436509' }, h("sc-tag", { key: 'f4851d6105f93f7fdd96785825f751349f6cff2c', type: "warning" }, h("div", { key: 'bc4ce320c39ee5255f1d97eacaa54596177289d5', class: "subscription-details__missing-method" }, h("sc-icon", { key: '73eb813e4bab657c6b77607811f6f853dd17e12f', name: "alert-triangle" }), wp.i18n.__('Payment Method Missing', 'surecart')))))));
    }
