...
const ScRichText = class {
    ...
    render() {
        var _a, _b, _c, _d, _e, _f, _g, _h;
        return (h(Host, { key: '19803338f1d12ab73589727e5ee85df7beda719b' }, h("sc-form-control", { key: 'b1a8e2ff4559c64f1d21b023cf29c5ab4f309fb3', exportparts: "label, help-text, form-control", size: this.size, required: this.required, label: this.label, showLabel: this.showLabel, help: this.help, inputId: this.inputId, helpId: this.helpId, labelId: this.labelId, name: this.name }, h("div", { key: '98aa742bc94edad7a9440cfb58d471d7852833bf', part: "base", class: { 'editor-base': true, 'editor--focused': this.hasFocus } }, h("div", { key: 'f33a05d9265a2bbf037f4b4c59a1d43621c39cff', class: "menu" }, h("sc-button", { key: 'beaed1c1ad58609b55d759068ad00df8baa6f0fe', size: "small", type: ((_b = (_a = this.editor) === null || _a === void 0 ? void 0 : _a.isActive) === null || _b === void 0 ? void 0 : _b.call(_a, 'bold')) ? 'default' : 'text', onClick: () => this.run('toggleBold'), disabled: !this.can('toggleBold') }, h("sc-icon", { key: '80e645813d320c2270c71124eba394230cff31b9', name: "bold" })), h("sc-button", { key: '3691861ddc305729845d11f0cd9e710329398012', size: "small", type: ((_d = (_c = this.editor) === null || _c === void 0 ? void 0 : _c.isActive) === null || _d === void 0 ? void 0 : _d.call(_c, 'italic')) ? 'default' : 'text', onClick: () => this.run('toggleItalic'), disabled: !this.can('toggleItalic') }, h("sc-icon", { key: '7a87eceffd5236b2006715052728913f016915aa', name: "italic" })), h("sc-button", { key: '464bd65f6dca27c30f26692c55486902cc334d33', size: "small", type: ((_f = (_e = this.editor) === null || _e === void 0 ? void 0 : _e.isActive) === null || _f === void 0 ? void 0 : _f.call(_e, 'bulletList')) ? 'default' : 'text', onClick: () => this.run('toggleBulletList') }, h("sc-icon", { key: 'f524d2767f7dd0d1ed263388c460a9dcfca1599d', name: "list" })), h("sc-button", { key: 'abb1ddb08510418dc44d5020cfcf30fe28b7b99f', size: "small", type: ((_h = (_g = this.editor) === null || _g === void 0 ? void 0 : _g.isActive) === null || _h === void 0 ? void 0 : _h.call(_g, 'strike')) ? 'default' : 'text', onClick: () => this.run('toggleStrike') }, h("sc-icon", { key: '027c701612295b946d2ff1fdda0d21b780bd4eb5', name: "minus" })), h("sc-button", { key: '538dec67b955209da8aa847cacb95537bb818101', class: "right", size: "small", type: "text", onClick: () => this.run('undo'), disabled: !this.can('undo') }, h("sc-icon", { key: '3c21df679e8a7510e2cb6ad5f01fe60e7fb95646', name: "corner-up-left" })), h("sc-button", { key: 'f7f0b8c2fb32d9b9f2211547b3efee305ebb7643', size: "small", type: "text", onClick: () => this.run('redo'), disabled: !this.can('redo') }, h("sc-icon", { key: '4a86430e457b8ef4a5dc1d1dc2d718ec1db4d5a6', name: "corner-up-right" }))), h("div", { key: '4a9ae2d5ad4a60ff6dd643ff0f5c62f314c0b675', part: "editor", class: {
                editor: true,
            }, ref: el => (this.element = el) })), this.remainingCharacters() < 20 && h("div", { key: 'adc7423b0c26e9d4c236f364ea1a84db5be98edd', class: 'textarea__char-limit-warning' }, wp.i18n.sprintf(wp.i18n.__('%d characters remaining', 'surecart'), this.remainingCharacters())))));
    }
};
